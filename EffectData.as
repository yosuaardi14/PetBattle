package
{
    ...
    public class EffectData
    {
        ...
        public static const EFFECT_DODGE:String = "dodge";
        ...
        public static const EFFECT_COILDING_WAVE:String = "coilding_wave";
        ...
        public static const EFFECT_PET_INTERNAL_INJURY:String = "internal_injury";
        ...
        public static const WIND_PEACE_ARR:Array = [EffectData.EFFECT_WIND_PEACE, EffectData.EFFECT_WIND_PEACE_2, EffectData.EFFECT_WIND_PEACE_3, EffectData.EFFECT_WIND_PEACE_4];

        public static const EFFECT_LIBRARY:Object = {
                ...
                "purify": "Purify",
                "reactive_force": "Reactive Force",
                "bleeding": "Bleeding",
                "burn": "Burn",
                "blind": "Blind",
                "bundle": "Restriction",
                "drain_chakra": "Drain CP",
                "drain_hp": "Drain HP",
                "poison": "Poison",
                "gate_opening": "Eight Extremities",
                "fear": "Fear",
                "soul_chain_bundle": "Soul Chain Bundle",
                "parasite": "Parasite",
                "chakra_sucker": "chakra_sucker",
                "burning": "Burning",
                "heal": "HP +",
                "fear_weaken": "Fear (Weaken)",
                "restore_cp": "CP +",
                "meridians_seal": "Meridians Seal (Restrict skills & charge)",
                "pet_burn": "Burn",
                "pet_fear_weaken": "Fear (Weaken)",
                "frenzy": "Frenzy",
                "burn_cp": "CP -",
                "mana_shield": "mana_shield",
                "heal_overtime": "heal_overtime",
                "cooldown_reduction": "Rapid Cooldown",
                "berserker_mode": "berserker_mode",
                "thunderstorm_mode": "thunderstorm_mode",
                "wind_peace": "Peace",
                "wind_peace_2": "Peace",
                "wind_peace_3": "Peace",
                "wind_peace_4": "Peace",
                "fire_energy_excitation": "Excitation",
                "excitation_cp": "excitation_cp",
                "excitation_charge": "excitation_charge",
                "lighting_bundle": "lighting_bundle",
                ...
                "silver_chain_bundle": "silver_chain_bundle",
                ...
                "pet_weaken": "Weaken",
                "catalytic_matter": "Catalytic",
                "dismantle": "Dismantle",
                "pet_freeze": "Frozen",
                "pet_damage_reduction": "Protection",
                "pet_damage_to_cp": "Stubborn",
                ...
                "light_impluse": "Hamstring",
                "dodge_reduction": "Numb",
                "distract": "Distract",
                "hamstring": "Hamstring",
                "ecstatic_sound": "Ecstacy",
                ...
                "skill_311": "skill_311",
                "skill_312": "skill_312",
                "restrict_charge": "Charge Disable",
                "crit_chance_dmg": "Mortal",
                "monster_hp1": "monster_hp1",
                "clearbuff_dodgereduction": "clearbuff_dodgereduction",
                "clearbuff_damagereduction": "clearbuff_damagereduction",
                "skill_285": "skill_285",
                "skill_287": "skill_287",
                "skill_234": "skill_234",
                "skill_236": "skill_236",
                ...
                "skill_253": "skill_253",
                "skill_268": "skill_268",
                "skill_268_2": "skill_268_2",
                "skill_270": "skill_270",
                "skill_2000": "skill_2000",
                "skill_2001": "skill_2001",
                "skill_2002": "skill_2002",
                "skill_2003": "skill_2003",
                "skill_2004": "skill_2004",
                "effect_decrease_critical_chance": "effect_decrease_critical_chance",
                "skill_335": "skill_335",
                ...
                "cut_half_hp": "cut_half_hp",
                "add_purify_chance": "add_purify_chance",
                "reduce_cp_require": "reduce_cp_require",
                "purify_restore_hp": "purify_restore_hp",
                "add_critical_chance": "add_critical_chance",
                "add_dodge_bonus": "add_dodge_bonus",
                "add_damage_bonus": "add_damage_bonus",
                "add_dodge_random": "add_dodge_random",
                "add_dodge_reduction": "add_dodge_reduction",
                "add_dodge_reduction_above_hp": "add_dodge_reduction_above_hp",
                "instant_kill_below_hp": "instant_kill_below_hp",
                "reduce_damage_bonus": "reduce_damage_bonus",
                "attacker_blind": "attacker_blind",
                "weapon_mana_shield": "weapon_mana_shield",
                "reduce_damage_bonus_present": "reduce_damage_bonus_present",
                "reduce_damage_amount": "reduce_damage_amount",
                "add_feedback_chance": "add_feedback_chance",
                "reduce_target_cp": "reduce_target_cp",
                "guard_below_damage": "guard_below_damage",
                "weapon_full_guard": "weapon_full_guard",
                "recieve_damage_cp": "recieve_damage_cp",
                "add_hp_amount": "add_hp_amount",
                "add_hp_amount_present": "add_hp_amount_present",
                "add_cp_amount_present": "add_cp_amount_present",
                "add_cp_below_cp": "add_cp_below_cp",
                "dodge_success_damage_bonus": "dodge_success_damage_bonus",
                "cp_consume_to_hp": "cp_consume_to_hp",
                "attacker_restore_hp": "attacker_restore_hp",
                "attacker_restore_cp": "attacker_restore_cp",
                "defender_damage_cp": "defender_damage_cp",
                "debuff_restore_hp_present": "debuff_restore_hp_present",
                "debuff_restore_cp_present": "debuff_restore_cp_present",
                "defender_burning": "defender_burning",
                "defender_bundle": "defender_bundle",
                "defender_poison": "defender_poison",
                "attacker_damage_reduction": "attacker_damage_reduction",
                "attacker_damage_bonus": "attacker_damage_bonus",
                "defender_clear_buff": "defender_clear_buff",
                "attack_reduce_cooldown": "attack_reduce_cooldown",
                "defender_freeze": "defender_freeze",
                "defender_critical_chance": "defender_critical_chance",
                "defender_restore_hp_present": "defender_restore_hp_present",
                "attacker_bleeding": "attacker_bleeding",
                "add_cp_amount": "add_cp_amount",
                "reduce_dodge_random": "reduce_dodge_random",
                "item_restore_bonus": "item_restore_bonus",
                "item_restore_bonus_present": "item_restore_bonus_present",
                "item_restore_cp_bonus_present": "item_restore_cp_bonus_present",
                "charge_cp_bonus": "charge_cp_bonus",
                "attacker_freeze": "attacker_freeze",
                "absorb_attacker_hp_present": "absorb_attacker_hp_present",
                ...
                "special_rune_scroll": "special_rune_scroll",
                "restore_percent_hp": "restore_percent_hp",
                "restore_percent_cp": "restore_percent_cp",
                "restore_percent_hpcp": "restore_percent_hpcp",
                "damage_bonus_n_reduction": "damage_bonus_n_reduction",
                "dodge_bonus_n_critical_chance": "dodge_bonus_n_critical_chance",
                "dodge_bonus_n_purify_chance": "dodge_bonus_n_purify_chance",
                "critical_chance_n_purify_chance": "critical_chance_n_purify_chance",
                "damage_bonus_n_accurate": "damage_bonus_n_accurate",
                "clearbuff_resist": "clearbuff_resist",
                "strengthen_n_bleeding": "strengthen_n_bleeding",
                "both_damage_reduction": "both_damage_reduction",
        ...
        public static function displaySpecialText(param1:Object, mapEffect:Boolean = false):String
        {
            ...
            /*if (param1.skill_hit_num >= 2) {
				_loc4_ = String(int(_loc4_) * int(param1.skill_hit_num));
			}*/
        ...
        public static function getFadeText(param1:String):String
        {
            switch (param1)
            {
                case EffectData.EFFECT_REACTIVE_DEBUFF:
                    return "Reactive Force Faded";
                default:
                    return "";
            }
        }
